...
class RestaurantsData extends StatefulWidget {
  @override
  _RestaurantsDataState createState() => _RestaurantsDataState();
}

class _RestaurantsDataState extends State<RestaurantsData> {
  String id = "";
              ...
              ElevatedButton(
                  onPressed: () async {
                    ...
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => RestaurantsData()));
                  },
                  child: Text("Submit"))
            ],
          ),
