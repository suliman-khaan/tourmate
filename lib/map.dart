...
class MapsDemo extends StatelessWidget {
  ...
  static const String ACCESS_TOKEN =
      "pk.eyJ1IjoidG91cm1hdGUiLCJhIjoiY2t2dnoyMGhpNDRyYTJ1cWdpZ2tjcHljeiJ9.1EiO4__daxl5iqLUjBJTBA";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ACCESS_TOKEN.isEmpty || ACCESS_TOKEN.contains("ACCESS_TOKEN")
