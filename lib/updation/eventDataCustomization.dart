...
import 'package:tourmate1/Data%20Entry%20Firestore/events_data.dart';
import 'package:tourmate1/updation/updateEventTable.dart';

class EventDataCustomization extends StatefulWidget {
  const EventDataCustomization({Key? key}) : super(key: key);

  @override
  State<EventDataCustomization> createState() => _EventDataCustomizationState();
}

class _EventDataCustomizationState extends State<EventDataCustomization> {
  @override
                    ...
                    rows: <DataRow>[
                      for (var i = 0; i < userInfoList.length; i++) ...[
                        DataRow(cells: [
                          ...
                          DataCell(Text("${userInfoList[i]["present"]}")),
                          ...
                          DataCell(TextButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => UpdateEventTable(
