...
import 'package:tourmate1/Data%20Entry%20Firestore/restaurants_data.dart';
import 'package:tourmate1/updation/updateRestaurantTable.dart';

class RestaurantDataCustomization extends StatefulWidget {
  const RestaurantDataCustomization({Key? key}) : super(key: key);

  @override
  State<RestaurantDataCustomization> createState() =>
      _RestaurantDataCustomizationState();
}

class _RestaurantDataCustomizationState
    extends State<RestaurantDataCustomization> {
  @override
                          ...
                          DataCell(TextButton(
                            ...
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => UpdateRestaurantTable(
