            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  Text("a) : 3 days prior to departure :  100% refundable "),
                  Text("b) : 2 days prior to departure : 75% refundable "),
                  Text(
                      "c) : 3 if customer not notify about the cancellation than one day payment  0% will be refundable and 100 % refundable other days"),
                  Text(
                  ...
                  Text(
                      "The Company forbids smoking in any vehicle operated by the Company. . All accommodation will be reserved with non-smoking rooms."),
                ],
              ),
            ),
          ),
